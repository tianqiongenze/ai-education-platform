...
| 教师 | teacher-zhang@edu.local | EdxTeacher2026! | 系统级教师测试账户（Open edX + JupyterHub，全部 32 个 Lecture staff，保留）；每个 Lecture 另有 teacher_<lec>_01/02 共 64 个关联教师账户（口令经 TEACHER_PASS 注入，见 `ACCOUNT-SYSTEM-DESIGN-V2.md` §4.3） |
